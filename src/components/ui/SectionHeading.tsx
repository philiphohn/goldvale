...
export default function SectionHeading({idx, title, moreText, moreLink}: SectionHeadingProps) {
  return (
    <div className="flex justify-between items-baseline gap-[1.5rem] flex-wrap mb-[clamp(2.5rem,5vw,4rem)] border-t border-[var(--color-line)] pt-[1.6rem]">
      ...
      <h2 className="font-semibold text-[clamp(1.9rem,3.4vw,2.9rem)] tracking-[-0.025em] lowercase">{title}</h2>
      {moreText && moreLink && (
