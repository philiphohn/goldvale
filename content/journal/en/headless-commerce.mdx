...
<div style={{border:"1px solid rgba(0,0,0,0.08)",borderRadius:"16px",padding:"24px",margin:"32px 0",background:"#0e0e10",color:"#f5f5f5"}}>
  <svg viewBox="0 0 640 220" width="100%" role="img" aria-label="Comparison of average load times: Monolith 3.2 seconds versus Headless 0.9 seconds">
    <text x="0" y="24" fill="#9a9aa2" fontFamily="sans-serif" fontSize="14">Average load time of a product page (LCP)</text>
    ...
    <text x="0" y="196" fill="#6f6f76" fontFamily="sans-serif" fontSize="12">Illustrative comparison. Real values depend on implementation, hosting, and data volume.</text>
  </svg>
</div>
