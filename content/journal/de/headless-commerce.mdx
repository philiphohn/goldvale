...
<div style={{border:"1px solid var(--color-border)",borderRadius:"16px",padding:"24px",margin:"32px 0",background:"var(--color-ink)",color:"var(--color-text)"}}>
  <svg viewBox="0 0 640 220" width="100%" role="img" aria-label="Vergleich der durchschnittlichen Ladezeit: Monolith 3,2 Sekunden gegenüber Headless 0,9 Sekunden">
    ...
    <rect x="120" y="70" width="470" height="22" rx="6" fill="var(--color-border-strong)"/>
    <rect x="120" y="70" width="470" height="22" rx="6" fill="var(--color-error)"/>
    ...
    <rect x="120" y="130" width="470" height="22" rx="6" fill="var(--color-border-strong)"/>
    <rect x="120" y="130" width="132" height="22" rx="6" fill="var(--color-gold)"/>
