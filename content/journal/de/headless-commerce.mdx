...
<div style={{border:"1px solid rgba(0,0,0,0.08)",borderRadius:"16px",padding:"24px",margin:"32px 0",background:"#0e0e10",color:"#f5f5f5"}}>
  <svg viewBox="0 0 640 220" width="100%" role="img" aria-label="Vergleich der durchschnittlichen Ladezeit: Monolith 3,2 Sekunden gegenüber Headless 0,9 Sekunden">
    <text x="0" y="24" fill="#9a9aa2" fontFamily="sans-serif" fontSize="14">Durchschnittliche Ladezeit einer Produktseite (LCP)</text>

    <text x="0" y="86" fill="#f5f5f5" fontFamily="sans-serif" fontSize="15">Monolith</text>
    <rect x="120" y="70" width="470" height="22" rx="6" fill="#3a3a40"/>
    <rect x="120" y="70" width="470" height="22" rx="6" fill="#c0392b"/>
    <text x="600" y="86" fill="#f5f5f5" fontFamily="sans-serif" fontSize="15" textAnchor="end" dx="-6">3,2 s</text>

    <text x="0" y="146" fill="#f5f5f5" fontFamily="sans-serif" fontSize="15">Headless</text>
    <rect x="120" y="130" width="470" height="22" rx="6" fill="#3a3a40"/>
    <rect x="120" y="130" width="132" height="22" rx="6" fill="#c9a54e"/>
    <text x="262" y="146" fill="#f5f5f5" fontFamily="sans-serif" fontSize="15" dx="8">0,9 s</text>

    <text x="0" y="196" fill="#6f6f76" fontFamily="sans-serif" fontSize="12">Illustrativer Vergleich. Reale Werte hängen von Implementierung, Hosting und Datenvolumen ab.</text>
  </svg>
</div>
