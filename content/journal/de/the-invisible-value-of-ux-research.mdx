...
flowchart LR
    ...
    style A fill:#162E24,stroke:#4CC38A,color:#7BD9AE
    style B fill:#3A2E17,stroke:#CBA45C,color:#E8CE92
    style C fill:#3E2A19,stroke:#E8973C,color:#EDB575
    style D fill:#3E1E1E,stroke:#F05656,color:#F58585
```
